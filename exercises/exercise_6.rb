...
@store2.employees.create(first_name: "Darryl", last_name: "Philbin", hourly_rate: 45)
@store2.employees.create(first_name: "Dwight Schrute", last_name: "Scott", hourly_rate: 40)